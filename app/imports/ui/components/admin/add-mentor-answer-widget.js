...
Template.Add_Mentor_Answer_Widget.events({
  submit(event, instance) {
    ...
    if (instance.context.isValid() &&
      ...
      console.log(newData);
      defineMethod.call({ collectionName: 'MentorAnswerCollection', definitionData: newData }, (error) => {
        if (error) {
...
Template.Add_Mentor_Answer_Widget.onRendered(function addMentorAnswerWidgetOnRendered() {
  // add your statement here
});

Template.Add_Mentor_Answer_Widget.onDestroyed(function addMentorAnswerWidgetOnDestroyed() {
  // add your statement here
});
