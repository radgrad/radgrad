...
/**
 * Provides an array containing MentorSpace questions definitions: question, text.
 *
 */
export const mentorspaceAnswersDefinitions = [
  {
    question: 'hiring-expectations',
    mentorID: 'brewer',
