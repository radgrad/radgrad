...
const eventOpportunityDefinitions = [
  ...
  },
  {
    ...
    sponsor: 'geraldlau',
    semesters: ['Fall-2016'],
    eventDate: new Date('2016-10-11'),
    interests: [],
    moreInformation: 'http://manoa.hawaii.edu/careercenter/students/career-fair/',
    ice: { i: 0, c: 0, e: 10 },
  },
  {
  ...
  },
  {
    ...
    sponsor: 'geraldlau',
    semesters: ['Fall-2016'],
    eventDate: new Date('2016-11-18'),
    interests: ['artificial-intelligence', 'application-development'],
    moreInformation: 'http://developer.ibm.com/iotplatform/events/att-iot-hackathon-dallas/',
    ice: { i: 15, c: 0, e: 15 },
  },
];
